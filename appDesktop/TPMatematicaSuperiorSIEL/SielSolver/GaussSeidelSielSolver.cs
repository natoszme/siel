...
namespace TPMatematicaSuperiorSIEL.SielSolver
{
    ...
    {
        public static void resolver(List<List<Double>> matrizCoeficientes, int tamanioMatrizCoeficientes, List<Double> terminosIndependientes, List<Double> incognitas)
        {
                ...
                if (criterioConvergencia())
                    return;
                resolver(matrizCoeficientes, tamanioMatrizCoeficientes, terminosIndependientes, incognitas);
        }

        public static bool criterioConvergencia()
        {
            return true;
        }
    }
